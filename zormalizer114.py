...
def remove_null_columns(filename):
    ...
    try:
        ...
        print(f"The specified Excel file '{filename}' was not found.")
        return
    ...
    # Step 1: Identify columns with names ending in "Name" and process them
    ...
    # Step 2: Iterate over each column to find null columns
    ...
    # Step 3: Delete identified columns
    for col_index in sorted(columns_to_delete, reverse=True):
        sheet.delete_cols(col_index)

    # Step 4: Style formatting for the header row
